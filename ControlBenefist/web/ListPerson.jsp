     ...
     <div class="container-interno relative"> 
      ...
      <div id="menuPrincipalItens" class="menu-principal-itens"> 
       ...
       <ul> 
        ...
        <li class="portlet"> <a href="PersonController?action=insert"> Adicionar Novo Beneficiário</a> </li> 
                            ...
                            <tbody>
                                    <c:forEach items="${persons}" var="person">
                                            <tr>
                                                    ...
                                                    <td>&nbsp;&nbsp;&nbsp;<a href="PersonController?action=edit&personId=<c:out value="${person.personId}"/>">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil-square-o" style="font-size:20px"></i> </a></td>
                                                    <td><a href="PersonController?action=delete&personId=<c:out value="${person.personId}"/>">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-trash" style="font-size:20px;color:red"></i></a></td>
                                            </tr>
                                    </c:forEach>
                            </tbody>
                    </table>
            <!--<a  role="button" class="btn btn-info btn-lg" data-toggle="modal">NOVO CLIENTE</a>-->	
            </div>
	</section>	
</div>
<br><br><br>
